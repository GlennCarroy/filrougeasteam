...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 05 mars 2018 à 11:22
...
CREATE TABLE `articles` (
  ...
  `categories` set('Environnement','Projets','Solidarité','') NOT NULL,
